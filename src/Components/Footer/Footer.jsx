...
const Footer = () => {
  ...
  const sections = [
    ...
    {
      title: "Products",
      links: ["All Apps",  "Developers", "Roadmap"],
    },
    {
      title: "Support",
    ...
    <footer className="bg-[#1A1A2E] text-white pt-16 pb-8 border-t border-indigo-800 font-[Inter]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-gray-400 max-w-sm text-sm leading-relaxed">
              We create innovative applications that simplify everyday life, empower people to achieve more, and bring ideas to reality—shaping the future, one app at a time.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p className="mb-4 md:mb-0">&copy; 2025 Hero.io, All rights reserved.</p>
